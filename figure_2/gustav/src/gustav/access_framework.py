...
def seg_swissprot(taxon_ncbi):
    """
    Low complexity regions on proteins existing in swissprot,
    inferred via SEG
...
def radar_swissprot(taxon_ncbi):
    """
    Repetiative regions in proteins existing in swissprot,
    inferred via RADAR
...
def signalp_swissprot(taxon_ncbi):
    """
    Signal peptides in proteins existing in swissprot,
    inferred via SignalP
